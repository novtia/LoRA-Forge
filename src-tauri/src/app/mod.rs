...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            crate::commands::dataset::import::import_dataset_images,
            crate::commands::dataset::import::import_edit_pair,
            crate::commands::dataset::import::set_dataset_control_dir,
            crate::commands::dataset::import::remove_dataset_control_dir,
            crate::commands::dataset::import::load_dataset_control_dirs,
            ...
            crate::commands::environment::list_training_repos,
            crate::commands::environment::add_custom_repo,
            crate::commands::environment::remove_custom_repo,
            crate::commands::environment::download_repo,
            crate::commands::environment::update_repo,
            crate::commands::environment::delete_repo,
            crate::commands::environment::cancel_repo_task,
            crate::commands::environment::inspect_environment,
